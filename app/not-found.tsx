    ...
    <>
      ...
      <div className="auth-grain" style={{ minHeight: "100vh", backgroundColor: "#efe6dc", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 16px", position: "relative", overflow: "hidden", fontFamily: "'Manrope', system-ui, sans-serif" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: "480px", width: "100%", backgroundColor: "#fbf8f4", border: "1px solid rgba(60,44,36,0.07)", borderRadius: "32px", padding: "52px 44px 44px", boxShadow: "0 8px 60px rgba(60,44,36,0.09), 0 1px 8px rgba(60,44,36,0.04)" }}>
          <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: "italic", fontSize: "72px", fontWeight: 300, lineHeight: 1, color: "#b43b32", margin: "0 0 4px", letterSpacing: "-0.02em" }}>
            404
          </div>
          <div style={{ width: "36px", height: "1px", backgroundColor: "#b43b32", margin: "20px auto 22px", opacity: 0.4 }} />
          <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "28px", fontWeight: 300, lineHeight: 1.25, letterSpacing: "0.01em", color: "#3c2c24", margin: "0 0 16px" }}>
          ...
          <Link href="/" className="btn-primary" style={{ display: "inline-block", padding: "16px 36px", borderRadius: "50px", backgroundColor: "#b43b32", color: "#ffffff", textDecoration: "none", fontFamily: "'Manrope', system-ui, sans-serif", fontWeight: 500, fontSize: "15px", letterSpacing: "0.04em", transition: "background-color 0.2s ease" }}>
